...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String liquid = JOptionPane.showInputDialog(null, "Enter any liquid");
		// Get the user to enter a body part
		String BPart = JOptionPane.showInputDialog(null, "Enter any body part");
