...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		int backColor = -10011977;
		int winColor = -1499549;
		//8. If the mouse falls off the path (if it is on the background)
	if (mouseColor == -10011977) {
		scare();
		showScaryImage("pixil-frame-0.png");
		try {
			new Robot().mouseMove(45, 95);
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Demon.wav"));
